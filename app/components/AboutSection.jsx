  ...
  return (
    ...
    >
      <div class="hidden md:block">
        <div className="absolute top-[10%] left-[40%] bg-purpleOne rounded-full w-72 h-72 mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-5000 pointer-events-none"></div>
        <div className="absolute bottom-[10%] right-[5%] bg-blueOne rounded-full w-72 h-72 mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-6000 pointer-events-none"></div>
        <div className="absolute bottom-[15%] left-[5%] bg-greenOne rounded-full w-72 h-72 mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-8000 pointer-events-none"></div>
      </div>
      <div className="md:hidden absolute top-1/4 right-1/4 bg-purpleOne rounded-full w-72 h-72 mix-blend-multiply filter blur-xl opacity-70 pointer-events-none"></div>
      <div className="items-start mt-4 gap-8 px-4 py-8 md:grid md:grid-cols-2 xl:gap-16 sm:py-16 xl:px-16">
        ...
        <div className="flex flex-col h-screen mt-4 text-center md:text-left md:mt-0">
          <h2 className="mb-4 text-4xl font-bold text-darkPurple uppercase">
            About Me
          </h2>
