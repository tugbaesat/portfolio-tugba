...
const PortfolioSection = () => {
  return (
    <section id="portfolio" className="relative min-h-screen">
      ...
      <div className="absolute top-0 bg-yellow-300 rounded-full -right-3 w-72 h-72 mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-2000 pointer-events-none"></div>
      <div className="absolute bg-pink-300 rounded-full -bottom-8 -left-30 w-72 h-72 mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-4000 pointer-events-none"></div>
